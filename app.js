...
async function rentals(){
 ...
 if(role==='owner'){
   ...
   $('rentals').innerHTML=`<h2>🏠 Rental Connect</h2>${paymentPrivacyNotice()}<h3>Available Owners / Rentals</h3><div id="rentalList" class="grid">${rentalCards(visibleRentals,role)}</div>${searchFilters}`;
 }
}
