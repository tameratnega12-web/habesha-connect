...
function marketplace(){
 ...
 <div class="notice"><b>Marketplace flow:</b> seller posts item → admin approves → buyer requests → admin approves → seller accepts → admin approves connection → seller marks sold.</div>
 <div class="grid two">
