...
function truck(){
 ...
 $('truck').innerHTML=`<h2>🚚 Trucking Connect</h2>${summary}${(role==='truck_owner'||role==='admin')?ownerPanel:''}${(role==='driver'||role==='admin')?driverPanel:''}${jobsTable}${appsTable}${recordsTable}`;
}
