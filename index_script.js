...
function seed(){return {currentUser:null,users:[],notifications:[],payments:[],messages:[],favorites:[],reviews:[],shipments:[],trips:[],rentals:[],rentalRequests:[],market:[],jobs:[],trucks:[],truckJobs:[],truckApplications:[],truckDriverProfiles:[],trailerRentals:[],businesses:[],settings:Object.assign({},DEFAULT_SETTINGS)}}
...
const ROLE_PAGES={
 ...
 traveler:['home','services','profile','shipping','home_services','messages','notifications',...PUBLIC_PAGES],
 sender:['home','services','profile','shipping','home_services','messages','notifications',...PUBLIC_PAGES],
 owner:['home','services','profile','rentals','home_services','messages','notifications',...PUBLIC_PAGES],
 rent_seeker:['home','services','profile','rentals','home_services','messages','notifications',...PUBLIC_PAGES],
 ...
 truck_owner:['home','profile','services','truck','home_services'],
 driver:['home','services','profile','truck','home_services','messages','notifications',...PUBLIC_PAGES],
 business_owner:['home','services','profile','home_services','business','marketplace','jobs','messages','notifications',...PUBLIC_PAGES]
};
...
function homeServices(){$('home_services').innerHTML=`<h2>🔧 Home Services</h2><div class="card"><h3>Home Services</h3><p class="muted">Cleaners, movers, repair, electricians, plumbers, and helpers.</p><p>This section is ready for the Home Services workflow.</p></div>`}
